"""
    ...
    Authors: Yixi Zhang / Abraham Otero
    Date: March 2026
    Usage: Run the file to train and configure a MPNN using chemprop and processed data split by both cc and ms from RepoRT.
    If the input datafiles do not exist, they will be built.
    Note: for this bachelor's thesis, this case scenario has not been evaluated, as k-fold cross-validation was not implemented.
    With single-fold, the results are not representative enough.
"""
...
path2res = os.path.join(".", "logs", moldesc_dir, dataset_type, filtering, "cc_scaffold_split", "dirname/")     # Change "dirname" for any name you want.
