...
Date: March 2026
Version: 1.0.
Usage: Run the file to train and configure a MPNN using chemprop and processed data scaffold split from RepoRT.
...
train_file = Path ("./data/processed_RepoRT/ms_split_data/train_data.tsv")
test_file = Path ("./data/processed_RepoRT/ms_split_data/test_data.tsv")
val_file = Path ("./data/processed_RepoRT/ms_split_data/val_data.tsv")
path2res = "./logs/RepoRT/ms_split_res/Results_try_1/"
param_dict = {
...
if __name__ == "__main__":
    if train_file.exists() and val_file.exists() and test_file.exists():
        ...
        ms_split () # This automatically get the files to the input path.
    train_df = pd.read_csv("./data/processed_RepoRT/ms_split_data/train_data.tsv", sep='\t').sample (400)
    test_df = pd.read_csv("./data/processed_RepoRT/ms_split_data/test_data.tsv", sep='\t').sample (50)
    val_df = pd.read_csv("./data/processed_RepoRT/ms_split_data/val_data.tsv", sep='\t').sample (50)
