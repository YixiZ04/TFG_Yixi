...
if __name__ == "__main__":
    ...
    train_df = pd.read_csv("./data/processed_RepoRT/ms_split_data/train_data.tsv", sep='\t')
    test_df = pd.read_csv("./data/processed_RepoRT/ms_split_data/test_data.tsv", sep='\t')
    val_df = pd.read_csv("./data/processed_RepoRT/ms_split_data/val_data.tsv", sep='\t')
