"""
    Trains a D-MPNN-based model for 10-fold cross-validation for random split case scenario: having seen the chromatographic condition in the train set.
    This would imply that in real-life standard metabolites are available or explicitly the chromatographic condition corresponds to one of the used.
