"""
    Trains a D-MPNN-based model for 10-fold cross-validation cc split.
    This was design to explicitly test the transferability on unseen chromatographic condition.
"""
